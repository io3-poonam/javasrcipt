...
const cartClick=()=>{
click=!click;
const showClick=document.querySelector('.aside')
if(click==true){
    showClick.classList.add('d-block')
    showClick.classList.remove('d-none')

}else{
    
    showClick.classList.remove("d-block")
    showClick.classList.add('d-none')
}
console.log('hhh', cartClick)
